...
public class MpGenerator {
    ...
    public static final String prefix = "D:\\Backup\\Document\\cloudclassroom";
    ...
    public static void main(String[] args) {
        ...
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
                strategy.setInclude(new String[]{"nkd_cas_employs","nkd_cas_depts"}); // 需要生成的表
        ...
        pc.setParent("com.dingxin");
        pc.setController("web.controller");
        pc.setService("web.service");
        pc.setServiceImpl("web.service.impl");
