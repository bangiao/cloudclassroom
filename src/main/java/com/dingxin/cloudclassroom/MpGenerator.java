package com.dingxin.cloudclassroom;
    ...
    public static void main(String[] args) {
        ...
        dsc.setTypeConvert(new MySqlTypeConvert() {
            ...
            public DbColumnType processTypeConvert(String fieldType) {
                ...
                DbColumnType dbColumnType = super.processTypeConvert(fieldType);
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/dx_cloud_cr?allowMultiQueries=true&useUnicode=true&characterEncoding=UTF-8");
        mpg.setDataSource(dsc);

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
        strategy.setTablePrefix(new String[]{"nkd_", "sys_", "cc_"});// 此处可以修改为您的表前缀
...
//        strategy.setInclude(new String[]{""}); // 需要生成的表
        ...
        pc.setParent("com.dingxin.cloudclassroom");
